...
export default function LoginPage() {
  ...
  const handleSocialLogin = (provider) => {
    ...
    if (provider === 'google') {
      url = `https://accounts.google.com/o/oauth2/v2/auth?client_id=${GOOGLE_ID}&redirect_uri=${encodeURIComponent(redirectUri)}&response_type=code&scope=email%20profile`;
    } else if (provider === 'github') {
      url = `https://github.com/login/oauth/authorize?client_id=${GITHUB_ID}&redirect_uri=${encodeURIComponent(redirectUri)}&scope=user:email`;
    }
        ...
        <div className="lp-card">
          ...
          <form className="lp-form" onSubmit={handleLogin}>
            ...
            <div className="lp-row-remember">
              ...
              <Link to="/forgot-password" className={`lp-forgot ${isLoading ? 'lp-link-disabled' : ''}`}>Forgot Password?</Link>
            </div>
          ...
          <div className="lp-social-btns" style={{ marginBottom: '-0.5rem' }}>
            <button type="button" className="lp-btn-social lp-btn-google" onClick={() => handleSocialLogin('google')} disabled={isLoading}>
            ...
            <button type="button" className="lp-btn-social lp-btn-github" onClick={() => handleSocialLogin('github')} disabled={isLoading}>
          ...
          <div className="lp-no-account" style={{ marginTop: '0.75rem' }}>
            Don't have an account?&nbsp;
            <Link to="/signup" className="lp-signup-link">Sign Up</Link>
          </div>
        </div>
      </div>
    </div>
